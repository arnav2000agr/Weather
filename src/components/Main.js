...
const Main = () => {
  ...
  useEffect(() =>{
    (async _ => {
          const response = await fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&APPID=${"804f3eb155c40011e48a4b2b1dcca1a7"}&units=metric&lang=${lang?('en'):('hi')}`);
